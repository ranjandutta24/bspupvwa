...
export const appRoutes: Route[] = [
    ...
    // Redirect empty path to '/files/files'
    { path: '', pathMatch: 'full', redirectTo: 'sign-in' },

    // Redirect signed-in user to the '/files/files'
    //
    // After the user signs in, the sign-in page will redirect the user to the 'signed-in-redirect'
    // path. Below is another redirection for that path to redirect the user to the desired
    // location. This is a small convenience to keep all main routes together here on this file.
    { path: 'signed-in-redirect', pathMatch: 'full', redirectTo: 'over-view' },
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            //     path: '',
            //     children: [
            //         { path: 'organization', loadChildren: () => import('app/modules/organization/organization.routes') },
            //     ]
            // },
            ...
            // Dashboards
            {
                path: 'dashboards', children: [
                    // { path: 'app-dashboard', loadChildren: () => import('app/modules/admin/dashboards/app-dashboard/app-dashboard.routes') },
                    // { path: 'project-dashboard', loadChildren: () => import('app/modules/admin/dashboards/project-dashboard/project-dashboard.routes') },
...

            {
                path: 'human-resource',
                children: [
                    { path: 'users', loadChildren: () => import('app/modules/human-resource/users/users.routes') },
            ...
            },
            {
                path: '',
                children: [
                    { path: 'over-view', loadChildren: () => import('app/modules/over-view/over-view.routes') },
...

            {
                path: '',
                children: [
                    { path: 'HSM-details', loadChildren: () => import('app/modules/HSM-details/HSM-details.routes') },
            ...
            },
            {
                path: '',
                children: [
                    { path: 'HSM-track', loadChildren: () => import('app/modules/HSM-track/HSM-track.routes') },
...

            {
                path: 'reports',
                children: [
                    { path: 'shift-hourly-report', loadChildren: () => import('app/modules/reports/shift-hourly-report/shift-hourly-report') },
                ]
            },

            {
                path: 'reports',
                children: [
                    { path: 'scheduled-report', loadChildren: () => import('app/modules/reports/scheduled-report/scheduled-report') },
                ]
            },

            {
                path: 'reports',
                children: [
                    { path: 'customer-prod', loadChildren: () => import('app/modules/reports/customer-prod/customer-prod') },
                ]
            },

            {
                path: 'reports',
                children: [
                    { path: 'quality-report', loadChildren: () => import('app/modules/reports/quality-report/quality-report') },
                ]
            },

            {
                path: 'reports',
                children: [
                    { path: 'technical-prod', loadChildren: () => import('app/modules/reports/technical-prod/technical-prod') },
                ]
            },

            {
                path: 'reports',
                children: [
                    { path: 'temp-trend-report', loadChildren: () => import('app/modules/reports/temp-trend-report/temp-trend-report') },
                ]
            },
